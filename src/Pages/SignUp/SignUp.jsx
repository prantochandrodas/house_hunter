                ...
                <div className="container flex items-center justify-center min-h-screen px-6 mx-auto">
                    <form className="w-full max-w-md">
                        ...
                        <div className="my-4">
                            ...
                            <select name="HeadlineAct" id="HeadlineAct" className="mt-1.5 w-full rounded-md py-3 border border-gray-300 text-gray-700 sm:text-sm">
                        ...
                        <div className="relative flex items-center mt-6">
                            ...
                            <input type="number" className="block w-full py-3 text-gray-700 bg-white border rounded-lg px-11 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" placeholder="phoneNumber" />
                        </div>
                        {/* email */}
                        <div className="relative flex items-center mt-6">
                            <span className="absolute">
